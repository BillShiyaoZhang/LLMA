...
public abstract class LLM {
    ...
    public abstract List<Float> getEmbeddings(String prompt);

    public abstract String think(String prompt);
    ...
    public int[] comepareComponenties(String source, String[] targets) {
        ...
        try{
            ...
            System.out.println("LLM: The result is not a number. Thought is: " + thought);
            return new int[0];
        }
    }
